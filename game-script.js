...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("submit-button").addEventListener("click", function () {   
        ...
        localStorage.setItem("chocolateBox", JSON.stringify(chocolateBox));
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("loveletter-submit-button").addEventListener("click", function () {
        ...
        localStorage.setItem("score", score);
        localStorage.setItem("selectedDropDown", JSON.stringify(selectedDropDown));
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function scoreRange(score){
        ...
        if(score >= 80 && score <= 100){
            ...
            document.getElementById("images").src = "images/endgame/end-game-best.svg";
...
//See my creation screen
document.addEventListener("DOMContentLoaded", function(){
    let chocolateBox = JSON.parse(localStorage.getItem("chocolateBox")) || [];
    ...
    let selectedDropDown = JSON.parse(localStorage.getItem("selectedDropDown")) || [];
